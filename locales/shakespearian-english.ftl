...
button-clear-cache = Purge the Cache <Del>  
...
button-copy = Make a Twin <Ctrl+C>  
...
confirmation-clear-cache-title = Purging the Cache  
confirmation-clear-cache-description = Dost thou truly wish to cleanse thy cache? The scrolls shall be reborn upon the next summoning of the client.  
