...
sounds = Töne
images = Bilder
rbxm-files = RBXM Dateien
ktx-files = KTX Dateien
...
# Bestätigungen
confirmation-generic-confirmation-title = Bestätigung
confirmation-delete-confirmation-title = Lösche Dateien
...
automatically-install-updates = Automatisch Aktualisierungen installieren
...
button-no = Nein
button-yes = Ja
new-updates = Neue Aktualisierungen available
download-update-question = Möchtest du die Aktualisierung herunterladen?
update-changelog = Aktualisierungsänderungsprotokoll unten
dependencies = Abhängigkeiten
contributors = Mitwirkende
button-rename = Umbenennen <F2>
